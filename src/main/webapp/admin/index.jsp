...
<body class="easyui-layout">
	<div data-options="region:'north',border:false"	style="height: 65px; background: #fe8642; padding: 0px">
		<div  style='background: url(../images/<at:param name="style.name" defaultValue="my" />_logo_64.gif) left top no-repeat;padding:0px; margin:0px;font-size: 16px; float:left;height:64px;width:100%;'>
